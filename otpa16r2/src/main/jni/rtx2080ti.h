#define THERMOPILE_IOCTL_MAGIC			'm'
#define THERMOPILE__SET_FRAMERATE	_IOR(THERMOPILE_IOCTL_MAGIC, 1, int *)
#define THERMOPILE__GET_FRANEDATA	_IOR(THERMOPILE_IOCTL_MAGIC, 2, int *)
#define DEVICE_NAME "/dev/THERMOPILE"
