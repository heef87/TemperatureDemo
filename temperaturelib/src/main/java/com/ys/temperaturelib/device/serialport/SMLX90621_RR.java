...
public class SMLX90621_RR extends ProductImp implements TemperatureParser<byte[]> {
    ...
    static final byte[] ORDER_DATA_OUTPUT = new byte[]{(byte) 0xA5, 0x06, 0x00, 0x00
            , 0x00, 0x42, (byte) 0xBF}; //查询输出数据指令
