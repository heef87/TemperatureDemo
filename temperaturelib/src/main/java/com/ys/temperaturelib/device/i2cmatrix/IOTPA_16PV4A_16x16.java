...
public class IOTPA_16PV4A_16x16 extends IMatrixThermometer implements TemperatureParser<float[]> {
    public static final String MODE_NAME = "OTPA-16PV4A-16*16";
    public static final int MATRIX_COUT_X = 16; //温度矩阵横坐标总数量
    public static final int MATRIX_COUT_Y = 16; //温度矩阵横坐标总数量
    Rtx2080ti rtx2080ti;

    public IOTPA_16PV4A_16x16() {
    ...
    public TakeTempEntity[] getDefaultTakeTempEntities() {
        ...
        entity4.setTakeTemperature(2f);//1.45  -0.4
        entities[4] = entity4;
        return entities;
    }
