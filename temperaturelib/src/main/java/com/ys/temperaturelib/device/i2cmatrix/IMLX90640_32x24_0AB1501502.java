...
public class IMLX90640_32x24_0AB1501502 extends IMatrixThermometer implements TemperatureParser<float[]> {
    public static final String MODE_NAME = "MLX90640-32*24-0AB1501502(矩阵)";
    static final int MATRIX_COUT_X = 32; //温度矩阵横坐标总数量
    static final int MATRIX_COUT_Y = 24; //温度矩阵横坐标总数量
    Mlx90640 mMlx90640;

    public IMLX90640_32x24_0AB1501502() {
