...
public class IOMRON_4x4 extends IMatrixThermometer implements TemperatureParser<float[]> {
    ...
    public IOMRON_4x4() {
        mOmron = new Omron();
        setParser(this);
        setMeasureParm(new MeasureParm(MODE_NAME, 50, 300, MATRIX_COUT_X, MATRIX_COUT_Y));
    ...
    public TakeTempEntity[] getDefaultTakeTempEntities() {
        ...
        entity1.setDistances(3);
        entity1.setTakeTemperature(1.3f);//0.3 0.6  -0.25  0.9
        entities[0] = entity1;

        TakeTempEntity entity2 = new TakeTempEntity();
        entity2.setDistances(20);
        entity2.setTakeTemperature(2.7f);//2.1 0.5  -0.95  0.7
        entities[1] = entity2;

        TakeTempEntity entity3 = new TakeTempEntity();
        entity3.setDistances(30);
        entity3.setTakeTemperature(3.3f);//5  0.4  -2.75  0
        entities[2] = entity3;

        TakeTempEntity entity4 = new TakeTempEntity();
        entity4.setDistances(35);
        entity4.setTakeTemperature(3.6f);//7.2  -0.8  -1.35  -0.45
        entities[3] = entity4;

        TakeTempEntity entity5 = new TakeTempEntity();
        entity5.setDistances(40);
        entity5.setTakeTemperature(3.7f);//8.7 -2.65  -0.4  -0.85
        entities[4] = entity5;

        TakeTempEntity entity6 = new TakeTempEntity();
        entity6.setDistances(45);
        entity6.setTakeTemperature(4f);//8.7 -2.65  -0.4  -0.85
        entities[5] = entity6;

        TakeTempEntity entity7 = new TakeTempEntity();
        entity7.setDistances(50);
        entity7.setTakeTemperature(4.2f);//8.7 -2.65  -0.4  -0.85
        entities[6] = entity7;
        return entities;
    }
    ...
    public TemperatureEntity parse(float[] data) {
        if (data != null) {
            ...
            entity.ta = data[16];
            entity.min = entity.max = check(data[0], entity);
